 ...
 */
final class Version20200624160924 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX lien ON exercice');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX lien ON exercice (lien(180))');
    }
}
